...
After dependencies validate, turn Kaggle Internet off for all model loading and execution. The notebook writes `dependency_report.json`, `dependency_freeze.txt`, `pip_check.txt`, `import_smoke_test.json`, and an asset-resolution report before any expensive operation.
