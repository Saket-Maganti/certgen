#!/usr/bin/env python3
"""Run one CertGen command CPU-only and append the canonical execution ledgers."""
...
LOG_ROOT = REPORTS / "execution_command_logs"
CSV_LEDGER = REPORTS / "CERTGEN_EXECUTION_COMMAND_LEDGER.csv"
JSONL_LEDGER = REPORTS / "CERTGEN_EXECUTION_COMMAND_LEDGER.jsonl"
FIELDS = [
    "sequence",
    "stage",
    "command",
...
def main() -> int:
    ...
    safe_stage = args.stage.replace("/", "_").replace(" ", "_")
    stem = f"{sequence:04d}_{safe_stage}"
