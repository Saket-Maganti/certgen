#!/usr/bin/env python3
"""Run one CPU-only remaining-closure command and append auditable ledgers."""
...
REPORT_ROOT = ROOT / "reports" / "icml2027" / "remaining_closure"
LOG_ROOT = REPORT_ROOT / "command_logs"
CSV_LEDGER = REPORT_ROOT / "CERTGEN_REMAINING_CLOSURE_COMMAND_LEDGER.csv"
JSONL_LEDGER = REPORT_ROOT / "CERTGEN_REMAINING_CLOSURE_COMMAND_LEDGER.jsonl"
FIELDS = (
    "sequence",
    "phase",
    "command",
