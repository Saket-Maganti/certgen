#!/usr/bin/env python3
"""Run one CPU-only final-closure command and append auditable ledgers."""
...
REPORT_ROOT = ROOT / "reports" / "icml2027" / "final_closure"
LOG_ROOT = REPORT_ROOT / "command_logs"
CSV_LEDGER = REPORT_ROOT / "CERTGEN_FINAL_CLOSURE_COMMAND_LEDGER.csv"
JSONL_LEDGER = REPORT_ROOT / "CERTGEN_FINAL_CLOSURE_COMMAND_LEDGER.jsonl"
FIELDS = (
...
def main(argv: list[str] | None = None) -> int:
    ...
    status = (
        ...
        else ("EXPECTED_BOUNDARY" if result.returncode in allowed else "FAIL")
    )
