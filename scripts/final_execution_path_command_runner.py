#!/usr/bin/env python3
"""Run one CPU-only command and append final execution-path audit ledgers."""
...
LOG_ROOT = REPORTS / "final_execution_path_command_logs"
CSV_LEDGER = REPORTS / "CERTGEN_FINAL_EXECUTION_PATH_COMMAND_LEDGER.csv"
JSONL_LEDGER = REPORTS / "CERTGEN_FINAL_EXECUTION_PATH_COMMAND_LEDGER.jsonl"
FIELDS = [
    "sequence", "phase", "command", "cwd", "start_utc", "end_utc",
    "duration_seconds", "exit_code", "stdout_log", "stderr_log", "status",
    "artifacts_created", "artifacts_reused", "blocker",
]
...
def main() -> int:
    ...
    row: dict[str, object] = {
        ...
        "start_utc": start_utc,
        "end_utc": end_utc,
        "duration_seconds": f"{time.monotonic() - started:.6f}",
