...
| `artifact_data/results/v7_multibench_candidate_validation.json` | `pass` | ok |
| `artifact_data/results/v9_runtime_budget_plan.json` | `pass` | ok |
| `artifact_data/results/v6_generation_output_validation_summary.json` | `pass` | ok |
| `artifact_data/results/v5_final_audit.json` | `pass` | ok |
| `artifact_data/results/r1b_feature_extraction_package_summary.json` | `pass` | ok |
| `artifact_data/results/cvpr_readiness_scorecard_v5.json` | `pass` | ok |
| `artifact_data/results/v2_first_pilot_plan.json` | `pass` | ok |
| `artifact_data/results/v7_cifar_reference_materialization_summary.json` | `pass` | ok |
| `artifact_data/results/v6_feature_input_zip_manifest.json` | `pass` | ok |
| `artifact_data/results/r4_result_eligibility.json` | `pass` | ok |
| `artifact_data/results/r1b_cifar10_reference_summary.json` | `pass` | ok |
...
| `artifact_data/results/v7_paper_result_gate.json` | `pass` | ok |
...
| `artifact_data/results/cvpr_paper_firewall.json` | `pass` | ok |
| `artifact_data/results/v4_final_audit.json` | `pass` | ok |
| `artifact_data/results/r2_scale_go_nogo.json` | `pass` | ok |
| `artifact_data/results/v4_metric_reproduction_audit.json` | `pass` | ok |
| `artifact_data/results/v9_cifar_reference_onramp.json` | `pass` | ok |
| `artifact_data/results/v5_state_intake.json` | `pass` | ok |
| `artifact_data/results/v9_paper_firewall.json` | `pass` | ok |
| `artifact_data/results/v5_release_safety.json` | `pass` | ok |
| `artifact_data/results/r1a_sample_materialization_audit.json` | `pass` | ok |
...
| `artifact_data/results/r1b_generated_manifest_summary.json` | `pass` | ok |
| `artifact_data/results/v7_metric_sanity_gates.json` | `pass` | ok |
| `artifact_data/results/v9_notebook_static_analysis.json` | `pass` | ok |
| `artifact_data/results/r0_cpu_gpu_audit.json` | `pass` | ok |
| `artifact_data/results/v3_final_audit.json` | `pass` | ok |
| `artifact_data/results/v7_execution_development_audit.json` | `pass` | ok |
| `artifact_data/results/v9_exact_next_action.json` | `pass` | ok |
| `artifact_data/results/optional_stopping_lab_v3.json` | `pass` | ok |
| `artifact_data/results/v7_notebook_quality.json` | `pass` | ok |
| `artifact_data/results/metric_reproduction_audit.json` | `pass` | ok |
| `artifact_data/results/v9_repo_snapshot_status.json` | `pass` | ok |
| `artifact_data/results/r1e_first_pilot_audit.json` | `pass` | ok |
| `artifact_data/results/v6_feature_output_validation_summary.json` | `pass` | ok |
| `artifact_data/results/r1e_undecided_fraction.json` | `pass` | ok |
| `artifact_data/results/v6_generation_input_zip_manifest.json` | `pass` | ok |
| `artifact_data/results/r1_cpu_validation.json` | `pass` | ok |
| `artifact_data/results/v7_checkpoint_preflight_status.json` | `pass` | ok |
| `artifact_data/results/v9_execution_supercharger_audit.json` | `pass` | ok |
| `artifact_data/results/r0_technical_correction_audit.json` | `pass` | ok |
| `artifact_data/results/r1c_feature_extraction_status.json` | `pass` | ok |
| `artifact_data/results/r3_multibench_availability.json` | `pass` | ok |
| `artifact_data/results/v5_related_work_audit.json` | `pass` | ok |
| `artifact_data/results/v9_execution_dashboard.json` | `pass` | ok |
| `artifact_data/results/r1d_metric_reproduction.json` | `pass` | ok |
| `artifact_data/results/v2_final_audit.json` | `pass` | ok |
| `artifact_data/results/final_execution_audit.json` | `pass` | ok |
| `artifact_data/results/certificate_replay.json` | `pass` | ok |
| `artifact_data/results/r1_source_selection_status.json` | `pass` | ok |
| `artifact_data/results/r1_cifar10_status.json` | `pass` | ok |
| `artifact_data/results/cvpr_reference_materialization.json` | `pass` | ok |
| `artifact_data/results/v5_claim_contract_audit.json` | `pass` | ok |
| `artifact_data/results/r1b_generation_package_audit.json` | `pass` | ok |
...
| `artifact_data/results/r0_cpu/provenance_validation.json` | `pass` | ok |
| `artifact_data/kaggle_uploads/certgen-generation/manifest.json` | `pass` | ok |
| `artifact_data/kaggle_uploads/certgen-features/manifest.json` | `pass` | ok |
