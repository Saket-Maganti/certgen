# cross-family adapter conformance
...
| `notebook` | notebooks/kaggle/icml2027/certgen_icml2027_cifar_cross_family_preflight_t4x2.ipynb |
...
| `expected_output` | certgen_icml2027_cross_family_preflight_output.zip |
