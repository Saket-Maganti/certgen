# public text-to-image prospective lane

| Field | Value |
|---|---|
| `purpose` | public text-to-image prospective lane |
| `prerequisite_state` | BLOCKED_PROMPT_SOURCE_LICENSE_MODEL_PROTOCOL |
| `input_builder` | python3 scripts/icml2027/build_kaggle_input.py --lane text_to_image |
| `input_ZIP` | BLOCKED_NOT_BUILT |
| `input_SHA256` | NOT_AVAILABLE_BLOCKED |
| `package_type` | authenticated_stage_input_or_blocked_plan |
| `notebook` | notebooks/kaggle/icml2027/text_to_image/certgen_icml2027_text_to_image_t4x2.ipynb |
...
| `expected_output` | certgen_icml2027_text_to_image_output.zip |
