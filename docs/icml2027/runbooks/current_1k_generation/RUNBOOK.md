# immutable pilot generation

| Field | Value |
|---|---|
| `purpose` | immutable pilot generation |
| `prerequisite_state` | BLOCKED_PENDING_PREFLIGHT_IMPORT |
| `input_builder` | python3 -m certgen kaggle build-input --stage generation --scale 1k --json |
| `input_ZIP` | BLOCKED_NOT_BUILT |
| `input_SHA256` | NOT_AVAILABLE_BLOCKED |
| `package_type` | authenticated_stage_input_or_blocked_plan |
| `notebook` | notebooks/kaggle/certgen_cvpr_generation_1k_t4x2.ipynb |
...
| `expected_output` | certgen_icml2027_current_1k_generation_output.zip |
