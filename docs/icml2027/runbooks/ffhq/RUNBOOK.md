# FFHQ prospective lane

| Field | Value |
|---|---|
| `purpose` | FFHQ prospective lane |
| `prerequisite_state` | BLOCKED_SOURCE_LICENSE_PROTOCOL |
| `input_builder` | python3 scripts/icml2027/build_kaggle_input.py --lane ffhq |
| `input_ZIP` | BLOCKED_NOT_BUILT |
| `input_SHA256` | NOT_AVAILABLE_BLOCKED |
| `package_type` | authenticated_stage_input_or_blocked_plan |
| `notebook` | notebooks/kaggle/icml2027/ffhq/certgen_icml2027_ffhq_t4x2.ipynb |
...
| `expected_output` | certgen_icml2027_ffhq_output.zip |
