# immutable pilot features

| Field | Value |
|---|---|
| `purpose` | immutable pilot features |
| `prerequisite_state` | BLOCKED_PENDING_GENERATION_IMPORT |
| `input_builder` | python3 -m certgen kaggle build-input --stage features --scale 1k --json |
| `input_ZIP` | BLOCKED_NOT_BUILT |
| `input_SHA256` | NOT_AVAILABLE_BLOCKED |
| `package_type` | authenticated_stage_input_or_blocked_plan |
| `notebook` | notebooks/kaggle/certgen_cvpr_feature_extraction_t4x2.ipynb |
...
| `expected_output` | certgen_icml2027_current_1k_features_output.zip |
